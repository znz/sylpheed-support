...
class ArticlesTest < ApplicationSystemTestCase
  ...
  test "creating a Article" do
    ...
    fill_in "Delete Flg", with: @article.delete_flg
    fill_in "Mail Addr", with: @article.mail_addr
    fill_in "Name", with: @article.name
    fill_in "Password", with: @article.password
    fill_in "Pthread", with: @article.pthread_id
    fill_in "Remote Addr", with: @article.remote_addr
